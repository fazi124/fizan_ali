        ...
        <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textcontainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>helo@react.dev</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>address</h2>
                    <span>helo street thatha ghara</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>phone</h2>
                    <span>+92 8739 842</span>
                </motion.div>
            </motion.div>
            <div className="formcontainer">
                    ...
                    >
                        <g>
                            <g>
                                ...
                                l34.2-34.2c3.4-3.4,8.8-7.5,15.1-7.5c6.2,0,11.3,3.9,14.4,7.3c0.1,0.1,0.1,0.1,0.2,0.2l65.1,64.8
                                C421.956,377.406,421.956,388.206,410.256,398.806z"
                                />
                            </g>
                        </g>
                    </svg>
             ...
             transition={{delay:4,duration:1}}>
                ...
                <textarea rows={8} placeholder='message' /><br/>
